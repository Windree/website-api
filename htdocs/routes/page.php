...
$router->get('/api/content/{path}', function ($path) use ($router) {
    return response()->json(array('cols' => 2, 'items' => array(
        array(
            ...
            'link' => array('page' => array('id' => 10001, 'name' => 'sculptures', 'title' => 'STures','date'=>'2019'))
        ),
        array(
            ...
            'link' => array('page' => array('id' => 10002, 'name' => 'instalations', 'title' => 'Insta','date'=>'2030'))
        ),
        array(
            ...
            'link' => array('page' => array('id' => 10003, 'name' => 'paitings', 'title' => 'Paint','date'=>'2021'))
        ),
        array(
            ...
            'link' => array('page' => array('id' => 10004, 'name' => 'videos', 'title' => 'Video HD','date'=>'2022'))
        )
    )));
});
